<template>
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="flex justify-center flex-col items-center">
      <h2 class="animate-slideInFromLeft flex justify-center text-4xl text-primary font-bold mb-2">About Me</h2>
      <!-- text-4xl font-semibold text-white relative pt-2 -->
      <span class="delay-300 text-3xl font-semibold text-white">
