<template>
  <div v-fade-in
    ...
    <svg class="w-12 h-12 mb-2 transition-all ease-in-out group-hover:scale-105" :class="color" :viewBox="viewBox"
      fill="currentColor">
    ...
    <span class="transition-all ease-in-out group-hover:scale-100 text-white">{{ name
      }}</span>
  </div>
</template>
